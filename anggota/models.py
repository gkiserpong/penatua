...
class Pengusul(models.Model):
    ...
    '''
    penatua_wilayah_1 = models.ForeignKey(
        Wilayah,
        on_delete=models.CASCADE,
        verbose_name='Wilayah Penatua 1',
        related_name='penatua_wilayah_1'    
    )
    '''
    ...
    '''
    penatua_wilayah_2 = models.ForeignKey(
        Wilayah,
        on_delete=models.CASCADE,
        verbose_name='Wilayah Penatua 2',
        related_name='penatua_wilayah_2',
        blank = True,
        null = True    
    )
    '''
    ...
    '''
    penatua_wilayah_3 = models.ForeignKey(
        Wilayah,
        on_delete=models.CASCADE,
        verbose_name='Wilayah Penatua 3',
        related_name='penatua_wilayah_3',
        blank = True,
        null = True     
    )
    '''
    ...
    '''
    penatua_wilayah_4 = models.ForeignKey(
        Wilayah,
        on_delete=models.CASCADE,
        verbose_name='Wilayah Penatua 4',
        related_name='penatua_wilayah_4',
        blank = True,
        null = True     
    )
    '''
    ...
    '''
    penatua_wilayah_5 = models.ForeignKey(
        Wilayah,
        on_delete=models.CASCADE,
        verbose_name='Wilayah Penatua 5',
        related_name='penatua_wilayah_5',
        blank = True,
        null = True    
    )
    '''
